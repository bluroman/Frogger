...
class TurtleGroup extends FlxTypedSpriteGroup<FlxSprite>
{
    ...
    {
        super();
        turtlesA11 = new TurtlesA(0, calculateRow(Row), -1, -1, FlxObject.LEFT, actorSpeed);
        turtlesA21 = new TurtlesA((TurtlesA.SPRITE_WIDTH + 100) * 1, calculateRow(Row), TurtlesA.DEFAULT_TIME, 250, FlxObject.LEFT, actorSpeed);
        turtlesA31 = new TurtlesA((TurtlesA.SPRITE_WIDTH + 100) * 2, calculateRow(Row), -1, -1, FlxObject.LEFT, actorSpeed);

        turtlesA1 = new TurtlesA(0, calculateRow(Row + 2), -1, -1, FlxObject.LEFT, actorSpeed);
        turtlesA2 = new TurtlesA((TurtlesA.SPRITE_WIDTH + 123) * 1, calculateRow(Row + 2), TurtlesA.DEFAULT_TIME, 200, FlxObject.LEFT, actorSpeed);
        turtlesA3 = new TurtlesA((TurtlesA.SPRITE_WIDTH + 123) * 2, calculateRow(Row + 2), -1, -1, FlxObject.LEFT, actorSpeed);

        turtlesB1 = new TurtlesB(0, calculateRow(Row + 5), TurtlesA.DEFAULT_TIME, 0, FlxObject.LEFT, actorSpeed);
        turtlesB2 = new TurtlesB((TurtlesB.SPRITE_WIDTH + 95) * 1, calculateRow(Row + 5), -1, -1, FlxObject.LEFT, actorSpeed);
        turtlesB3 = new TurtlesB((TurtlesB.SPRITE_WIDTH + 95) * 2, calculateRow(Row + 5), -1, -1, FlxObject.LEFT, actorSpeed);
