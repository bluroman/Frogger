...
class CarGroup extends FlxTypedSpriteGroup<FlxSprite>
{
	...
	public function new(X:Float, Y:Float, actorSpeed:Int)
	{
		...
		car2_2 = new Car(270, Y + PlayState.TILE_SIZE * 2, Car.TYPE_D, FlxDirectionFlags.LEFT, actorSpeed);
		car3_1 = new Car(0, Y + PlayState.TILE_SIZE * 3, Car.TYPE_B, FlxDirectionFlags.RIGHT, actorSpeed);
		car3_2 = new Car((Car.SPRITE_WIDTH + 138) * 1, Y + PlayState.TILE_SIZE * 3, Car.TYPE_B, FlxDirectionFlags.RIGHT, actorSpeed);
		car3_3 = new Car((Car.SPRITE_WIDTH + 138) * 2, Y + PlayState.TILE_SIZE * 3, Car.TYPE_B, FlxDirectionFlags.RIGHT, actorSpeed);
		car4_1 = new Car(0, Y + PlayState.TILE_SIZE * 4, Car.TYPE_A, FlxDirectionFlags.LEFT, actorSpeed);
		car4_2 = new Car((Car.SPRITE_WIDTH + 138) * 1, Y + PlayState.TILE_SIZE * 4, Car.TYPE_A, FlxDirectionFlags.LEFT, actorSpeed);
		car4_3 = new Car((Car.SPRITE_WIDTH + 138) * 2, Y + PlayState.TILE_SIZE * 4, Car.TYPE_A, FlxDirectionFlags.LEFT, actorSpeed);
		add(truck1);
		add(truck2);
		add(car1_1);
		add(car1_2);
