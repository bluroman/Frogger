...
class CarGroup extends FlxTypedSpriteGroup<FlxSprite>
{
    ...
    {
        super();
        truck1 = new Truck(0, calculateRow(9), FlxObject.LEFT, actorSpeed);
        truck2 = new Truck(270, calculateRow(9), FlxObject.LEFT, actorSpeed);
        car1_1 = new Car(0, calculateRow(10), Car.TYPE_C, FlxObject.RIGHT, actorSpeed* 2);
        car1_2 = new Car(270, calculateRow(10), Car.TYPE_C, FlxObject.RIGHT, actorSpeed* 2);
        car2_1 = new Car(0, calculateRow(11), Car.TYPE_D, FlxObject.LEFT, actorSpeed);
        car2_2 = new Car(270, calculateRow(11), Car.TYPE_D, FlxObject.LEFT, actorSpeed);
        car3_1 = new Car(0, calculateRow(12), Car.TYPE_B, FlxObject.RIGHT, actorSpeed);
        car3_2 = new Car((Car.SPRITE_WIDTH + 138) * 1, calculateRow(12), Car.TYPE_B, FlxObject.RIGHT, actorSpeed);
        car3_3 = new Car((Car.SPRITE_WIDTH + 138) * 2, calculateRow(12), Car.TYPE_B, FlxObject.RIGHT, actorSpeed);
        car4_1 = new Car(0, calculateRow(13), Car.TYPE_A, FlxObject.LEFT, actorSpeed);
        car4_2 = new Car((Car.SPRITE_WIDTH + 138) * 1, calculateRow(13), Car.TYPE_A, FlxObject.LEFT, actorSpeed);
        car4_3 = new Car((Car.SPRITE_WIDTH + 138) * 2, calculateRow(13), Car.TYPE_A, FlxObject.LEFT, actorSpeed);
        add(truck1);
        add(truck2);
        add(car1_1);
        add(car1_2);
